...
a.selection.replace(b,"$1 $2")};u.wrap=function(a,b){this.unwrap(a);b=new v("(.{1,"+b+"})( +|$\\n?)","gm");var d=this;a.selection=a.selection.replace(b,function(c,e){if((new v("^"+d.prefixes,"")).test(c))return c;return e+"\n"});a.selection=a.selection.replace(/\s+$/,"")};u.doBold=function(a,b){return this.doBorI(a,b,2,"strong text")};u.doItalic=function(a,b){return this.doBorI(a,b,1,"emphasized text")};u.doBorI=function(a,b,d,c){a.trimWhitespace();a.selection=a.selection.replace(/\n{2,}/g,"\n");
var e=/(\**$)/.exec(a.before)[0];b=/(^\**)/.exec(a.after)[0];e=Math.min(e.length,b.length);if(e>=d&&(e!=2||d!=1)){a.before=a.before.replace(v("[*]{"+d+"}$",""),"");a.after=a.after.replace(v("^[*]{"+d+"}",""),"")}else if(!a.selection&&b){a.after=a.after.replace(/^([*_]*)/,"");a.before=a.before.replace(/(\s?)$/,"");a.before=a.before+b+v.$1}else{if(!a.selection&&!b)a.selection=c;d=d<=1?"*":"**";a.before+=d;a.after=d+a.after}};u.stripLinkDefs=function(a,b){return a=a.replace(/^[ ]{0,3}\[(\d+)\]:[ \t]*\n?[ \t]*<?(\S+?)>?[ \t]*\n?[ \t]*(?:(\n*)["(](.+?)[")][ \t]*)?(?:\n+|$)/gm,
function(d,c,e,l,i){b[c]=d.replace(/\s*$/,"");if(l){b[c]=d.replace(/["(](.+?)[")]$/,"");return l+i}return""})};u.addLinkDef=function(a,b){var d=0,c={};a.before=this.stripLinkDefs(a.before,c);a.selection=this.stripLinkDefs(a.selection,c);a.after=this.stripLinkDefs(a.after,c);var e="",l=/(\[)((?:\[[^\]]*\]|[^\[\]])*)(\][ ]?(?:\n[ ]*)?\[)(\d+)(\])/g,i=function(h){d++;h=h.replace(/^[ ]{0,3}\[(\d+)\]:/,"  ["+d+"]:");e+="\n"+h},p=function(h,g,n,t,o,A){n=n.replace(l,p);if(c[o]){i(c[o]);return g+n+t+d+A}return h};
a.before=a.before.replace(l,p);if(b)i(b);else a.selection=a.selection.replace(l,p);b=d;a.after=a.after.replace(l,p);if(a.after)a.after=a.after.replace(/\n*$/,"");if(!a.after)a.selection=a.selection.replace(/\n*$/,"");a.after+="\n\n"+e;return b};u.doLinkOrImage=function(a,b,d){a.trimWhitespace();a.findTags(/\s*!?\[/,/\][ ]?(?:\n[ ]*)?(\[.*?\])?/);var c;if(a.endTag.length>1&&a.startTag.length>0){a.startTag=a.startTag.replace(/!?\[/,"");a.endTag="";this.addLinkDef(a,null)}else{a.selection=a.startTag+
a.selection+a.endTag;a.startTag=a.endTag="";if(/\n\n/.test(a.selection))this.addLinkDef(a,null);else{var e=this,l=function(i){c.parentNode.removeChild(c);if(i!==null){a.selection=(" "+a.selection).replace(/([^\\](?:\\\\)*)(?=[[\]])/g,"$1\\").substr(1);i=" [999]: "+P(i);i=e.addLinkDef(a,i);a.startTag=d?"![":"[";a.endTag="]["+i+"]";if(!a.selection)a.selection=d?"enter image description here":"enter link description here"}b()};c=E.createBackground();if(d)this.hooks.insertImageDialog(l)||E.prompt("<p><strong>Insert Image</strong></p><p>http://example.com/images/diagram.jpg</p>",
"http://",l);else E.prompt("<p><strong>Insert Hyperlink</strong></p>","http://",l);return true}}};u.doAutoindent=function(a){var b=this;a.before=a.before.replace(/(\n|^)[ ]{0,3}([*+-]|\d+[.])[ \t]*\n$/,"\n\n");a.before=a.before.replace(/(\n|^)[ ]{0,3}>[ \t]*\n$/,"\n\n");a.before=a.before.replace(/(\n|^)[ \t]+\n$/,"\n\n");/(\n|^)[ ]{0,3}([*+-]|\d+[.])[ \t]+.*\n$/.test(a.before)&&b.doList&&b.doList(a);/(\n|^)[ ]{0,3}>[ \t]+.*\n$/.test(a.before)&&b.doBlockquote&&b.doBlockquote(a);/(\n|^)(\t|[ ]{4,}).*\n$/.test(a.before)&&
b.doCode&&b.doCode(a)};u.doBlockquote=function(a){a.selection=a.selection.replace(/^(\n*)([^\r]+?)(\n*)$/,function(h,g,n,t){a.before+=g;a.after=t+a.after;return n});a.before=a.before.replace(/(>[ \t]*)$/,function(h,g){a.selection=g+a.selection;return""});a.selection=a.selection.replace(/^(\s|>)+$/,"");a.selection=a.selection||"Blockquote";var b="",d="",c;if(a.before){for(var e=a.before.replace(/\n$/,"").split("\n"),l=false,i=0;i<e.length;i++){var p=false;c=e[i];l=l&&c.length>0;if(/^>/.test(c)){p=
true;if(!l&&c.length>1)l=true}else p=/^[ \t]*$/.test(c)?true:l;if(p)b+=c+"\n";else{d+=b+c;b="\n"}}if(!/(^|\n)>/.test(b)){d+=b;b=""}}a.startTag=b;a.before=d;if(a.after)a.after=a.after.replace(/^\n?/,"\n");a.after=a.after.replace(/^(((\n|^)(\n[ \t]*)*>(.+\n)*.*)+(\n[ \t]*)*)/,function(h){a.endTag=h;return""});b=function(h){var g=h?"> ":"";if(a.startTag)a.startTag=a.startTag.replace(/\n((>|\s)*)\n$/,function(n,t){return"\n"+t.replace(/^[ ]{0,3}>?[ \t]*$/gm,g)+"\n"});if(a.endTag)a.endTag=a.endTag.replace(/^\n((>|\s)*)\n/,
function(n,t){return"\n"+t.replace(/^[ ]{0,3}>?[ \t]*$/gm,g)+"\n"})};if(/^(?![ ]{0,3}>)/m.test(a.selection)){this.wrap(a,H.lineLength-2);a.selection=a.selection.replace(/^/gm,"> ");b(true);a.skipLines()}else{a.selection=a.selection.replace(/^[ ]{0,3}> ?/gm,"");this.unwrap(a);b(false);if(!/^(\n|^)[ ]{0,3}>/.test(a.selection)&&a.startTag)a.startTag=a.startTag.replace(/\n{0,2}$/,"\n\n");if(!/(\n|^)[ ]{0,3}>.*$/.test(a.selection)&&a.endTag)a.endTag=a.endTag.replace(/^\n{0,2}/,"\n\n")}a.selection=this.hooks.postBlockquoteCreation(a.selection);
if(!/\n/.test(a.selection))a.selection=a.selection.replace(/^(> *)/,function(h,g){a.startTag+=g;return""})};u.doCode=function(a){var b=/\S[ ]*$/.test(a.before);if(!/^[ ]*\S/.test(a.after)&&!b||/\n/.test(a.selection)){a.before=a.before.replace(/[ ]{4}$/,function(c){a.selection=c+a.selection;return""});var d=b=1;if(/\n(\t|[ ]{4,}).*\n$/.test(a.before))b=0;if(/^\n(\t|[ ]{4,})/.test(a.after))d=0;a.skipLines(b,d);if(a.selection)a.selection=/^[ ]{0,3}\S/m.test(a.selection)?a.selection.replace(/^/gm,"    "):
a.selection.replace(/^[ ]{4}/gm,"");else{a.startTag="    ";a.selection="enter code here"}}else{a.trimWhitespace();a.findTags(/`/,/`/);if(!a.startTag&&!a.endTag){a.startTag=a.endTag="`";if(!a.selection)a.selection="enter code here"}else if(a.endTag&&!a.startTag){a.before+=a.endTag;a.endTag=""}else a.startTag=a.endTag=""}};u.doList=function(a,b,d){b=/^\n*(([ ]{0,3}([*+-]|\d+[.])[ \t]+.*)(\n.+|\n{2,}([*+-].*|\d+[.])[ \t]+.*|\n{2,}[ \t]+\S.*)*)\n*/;var c="-",e=1,l=function(){var n;if(d){n=" "+e+". ";
e++}else n=" "+c+" ";return n},i=function(n){if(d===undefined)d=/^\s*\d/.test(n);return n=n.replace(/^[ ]{0,3}([*+-]|\d+[.])\s/gm,function(){return l()})};a.findTags(/(\n|^)*[ ]{0,3}([*+-]|\d+[.])\s+/,null);if(a.before&&!/\n$/.test(a.before)&&!/^\n/.test(a.startTag)){a.before+=a.startTag;a.startTag=""}if(a.startTag){var p=/\d+[.]/.test(a.startTag);a.startTag="";a.selection=a.selection.replace(/\n[ ]{4}/g,"\n");this.unwrap(a);a.skipLines();if(p)a.after=a.after.replace(b,i);if(d==p)return}var h=1;a.before=
a.before.replace(/(\n|^)(([ ]{0,3}([*+-]|\d+[.])[ \t]+.*)(\n.+|\n{2,}([*+-].*|\d+[.])[ \t]+.*|\n{2,}[ \t]+\S.*)*)\n*$/,function(n){if(/^\s*([*+-])/.test(n))c=v.$1;h=/[^\n]\n\n[^\n]/.test(n)?1:0;return i(n)});if(!a.selection)a.selection="List item";p=l();var g=1;a.after=a.after.replace(b,function(n){g=/[^\n]\n\n[^\n]/.test(n)?1:0;return i(n)});a.trimWhitespace(true);a.skipLines(h,g,true);a.startTag=p;b=p.replace(/./g," ");this.wrap(a,H.lineLength-b.length);a.selection=a.selection.replace(/\n/g,"\n"+
b)};u.doHeading=function(a){a.selection=a.selection.replace(/\s+/g," ");a.selection=a.selection.replace(/(^\s+|\s+$)/g,"");if(a.selection){var b=0;a.findTags(/#+[ ]*/,/[ ]*#+/);if(/#+/.test(a.startTag))b=v.lastMatch.length;a.startTag=a.endTag="";a.findTags(null,/\s?(-+|=+)/);if(/=+/.test(a.endTag))b=1;if(/-+/.test(a.endTag))b=2;a.startTag=a.endTag="";a.skipLines(1,1);b=b==0?2:b-1;if(b>0){b=b>=2?"-":"=";var d=a.selection.length;if(d>H.lineLength)d=H.lineLength;for(a.endTag="\n";d--;)a.endTag+=b}}else{a.startTag=
"## ";a.selection="Heading";a.endTag=" ##"}};u.doHorizontalRule=function(a){a.startTag="----------\n";a.selection="";a.skipLines(2,1,true)};u.doMoreTag=function(a){a.startTag="<!--more--\>\n";a.selection="";a.skipLines(2,1,true)}})();
